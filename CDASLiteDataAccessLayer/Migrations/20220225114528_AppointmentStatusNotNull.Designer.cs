...
namespace CDASLiteDataAccessLayer.Migrations
{
    ...
    [Migration("20220225114528_AppointmentStatusNotNull")]
    partial class AppointmentStatusNotNull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.IdentityModels.AppRole", b =>
                {
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.IdentityModels.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Clinic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Doctor", b =>
                {
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Hospital", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Patient", b =>
                {
                    b.Property<string>("TRID")
                        .HasMaxLength(11)
                        .HasColumnType("nvarchar(11)");
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("CDASLiteEntityLayer.Models.Patient", "Patient")
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.District", b =>
                {
                    b.HasOne("CDASLiteEntityLayer.Models.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Doctor", b =>
                {
                    b.HasOne("CDASLiteEntityLayer.IdentityModels.AppUser", "AppUser")
                        .WithMany("Doctors")
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.Hospital", b =>
                {
                    b.HasOne("CDASLiteEntityLayer.Models.District", "HospitalDistrict")
                        .WithMany("DistrictHospitals")
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.HospitalClinic", b =>
                {
                    ...
                    b.HasOne("CDASLiteEntityLayer.Models.Doctor", "Doctor")
                        .WithMany("HospitalClinics")
                        .HasForeignKey("DoctorId");

                    b.HasOne("CDASLiteEntityLayer.Models.Hospital", "Hospital")
                        .WithMany("HospitalClinics")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CDASLiteEntityLayer.IdentityModels.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CDASLiteEntityLayer.IdentityModels.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CDASLiteEntityLayer.Models.District", b =>
                {
                    b.Navigation("DistrictHospitals");
                });
